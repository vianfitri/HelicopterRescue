...
class IconRenderer:
    ...
    def draw_plug(gc: wx.GraphicsContext, x: float, y: float, size: float, color: wx.Colour):
        ...
        path_icn.MoveToPoint(37.5811, 42.3438)
        path_icn.AddCurveToPoint(34.5436, 39.3001, 29.5749, 39.3001, 26.5311, 42.3438)
        path_icn.AddLineToPoint(25.1561, 43.7188)
        path_icn.AddCurveToPoint(20.9311, 47.9376, 18.6561, 53.5563, 18.7499, 59.5251)
        path_icn.AddCurveToPoint(18.8249, 64.25, 20.3749, 68.7125, 23.1874, 72.3937)
        path_icn.AddLineToPoint(10.2936, 85.2875)
        path_icn.AddCurveToPoint(9.0749, 86.5062, 9.0749, 88.4875, 10.2936, 89.7062)
        path_icn.AddCurveToPoint(10.9061, 90.3188, 11.7061, 90.6188, 12.5061, 90.6188)
        path_icn.AddCurveToPoint(13.3061, 90.6188, 14.1061, 90.3125, 14.7186, 89.7062)
        path_icn.AddLineToPoint(27.6561, 76.7687)
        path_icn.AddCurveToPoint(31.3874, 79.4875, 35.8561, 80.8438, 40.3811, 80.8438)
        #path_icn.AddCurveToPoint(46.2436, 80.8438, 52.1811, 78.575, 56.6561, 74.0938)
        #path_icn.AddLineToPoint(57.4749, 73.275)
        #path_icn.AddCurveToPoint(60.5186, 70.2313, 60.5186, 65.275, 57.4749, 62.2251)
        #path_icn.AddLineToPoint(37.5874, 42.3376)
        #path_icn.AddLineToPoint(37.5811, 42.3438)
